    ...
    public partial class CriacaoInicialDoBanco : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Funcionarios",
                columns: new[] { "Id", "Cargo", "Email", "Endereco", "Nome", "Telefone" },
                values: new object[] { 1, "Admin", "admin@admin.com", "Sistema", "Administrador", "(00) 00000-0000" });

            migrationBuilder.InsertData(
                table: "Logins",
                columns: new[] { "Id", "IdFuncionario", "Senha", "Usuario" },
                values: new object[] { 1, 1, "pmWkWSBCL51Bfkhn79xPuKBKHz//H6B+mY6G9/eieuM=", "admin@admin.com" });
